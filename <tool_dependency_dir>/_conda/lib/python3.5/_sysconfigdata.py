...
build_time_vars = {'ABIFLAGS': 'm',
 ...
 'BASECPPFLAGS': '',
 'BASEMODLIBS': '',
 'BINDIR': '/home/galaxy/galaxy/<tool_dependency_dir>/_conda/bin',
 'BINLIBDEST': '/home/galaxy/galaxy/<tool_dependency_dir>/_conda/lib/python3.5',
 'BLDLIBRARY': '-L. -lpython3.5m',
 'BLDSHARED': 'gcc -pthread -shared -L/home/galaxy/galaxy/<tool_dependency_dir>/_conda/lib '
              '-Wl,-rpath=/home/galaxy/galaxy/<tool_dependency_dir>/_conda/lib,--no-as-needed',
 'BUILDEXE': '',
 'BUILDPYTHON': 'python',
 ...
 'CONFIGURE_CPPFLAGS': '-I/home/galaxy/galaxy/<tool_dependency_dir>/_conda/include',
 'CONFIGURE_LDFLAGS': '-L/home/galaxy/galaxy/<tool_dependency_dir>/_conda/lib '
                      '-Wl,-rpath=/home/galaxy/galaxy/<tool_dependency_dir>/_conda/lib,--no-as-needed',
 'CONFIG_ARGS': "'--enable-shared' '--enable-ipv6' '--with-ensurepip=no' "
                "'--prefix=/home/galaxy/galaxy/<tool_dependency_dir>/_conda' "
                "'--with-tcltk-includes=-I/home/galaxy/galaxy/<tool_dependency_dir>/_conda/include' "
                "'--with-tcltk-libs=-L/home/galaxy/galaxy/<tool_dependency_dir>/_conda/lib "
                "-ltcl8.5 -ltk8.5' "
                "'CPPFLAGS=-I/home/galaxy/galaxy/<tool_dependency_dir>/_conda/include' "
                "'LDFLAGS=-L/home/galaxy/galaxy/<tool_dependency_dir>/_conda/lib "
                "-Wl,-rpath=/home/galaxy/galaxy/<tool_dependency_dir>/_conda/lib,--no-as-needed' "
                "'PKG_CONFIG_PATH=/home/galaxy/galaxy/<tool_dependency_dir>/_conda/lib/pkgconfig'",
 'CONFINCLUDEDIR': '/home/galaxy/galaxy/<tool_dependency_dir>/_conda/include',
 'CONFINCLUDEPY': '/home/galaxy/galaxy/<tool_dependency_dir>/_conda/include/python3.5m',
 ...
 'CPPFLAGS': '-I. -IInclude -I./Include '
             '-I/home/galaxy/galaxy/<tool_dependency_dir>/_conda/include',
 'CXX': 'g++ -pthread',
 'DESTDIRS': '/home/galaxy/galaxy/<tool_dependency_dir>/_conda '
             '/home/galaxy/galaxy/<tool_dependency_dir>/_conda/lib '
             '/home/galaxy/galaxy/<tool_dependency_dir>/_conda/lib/python3.5 '
             '/home/galaxy/galaxy/<tool_dependency_dir>/_conda/lib/python3.5/lib-dynload',
 'DESTLIB': '/home/galaxy/galaxy/<tool_dependency_dir>/_conda/lib/python3.5',
 'DESTPATH': '',
 'DESTSHARED': '/home/galaxy/galaxy/<tool_dependency_dir>/_conda/lib/python3.5/lib-dynload',
 'DIRMODE': 755,
 ...
 'INCLDIRSTOMAKE': '/home/galaxy/galaxy/<tool_dependency_dir>/_conda/include '
                   '/home/galaxy/galaxy/<tool_dependency_dir>/_conda/include '
                   '/home/galaxy/galaxy/<tool_dependency_dir>/_conda/include/python3.5m '
                   '/home/galaxy/galaxy/<tool_dependency_dir>/_conda/include/python3.5m',
 'INCLUDEDIR': '/home/galaxy/galaxy/<tool_dependency_dir>/_conda/include',
 'INCLUDEPY': '/home/galaxy/galaxy/<tool_dependency_dir>/_conda/include/python3.5m',
 ...
 'LDLIBRARYDIR': '',
 'LDSHARED': 'gcc -pthread -shared -L/home/galaxy/galaxy/<tool_dependency_dir>/_conda/lib '
             '-Wl,-rpath=/home/galaxy/galaxy/<tool_dependency_dir>/_conda/lib,--no-as-needed',
 'LDVERSION': '3.5m',
 'LIBC': '',
 'LIBDEST': '/home/galaxy/galaxy/<tool_dependency_dir>/_conda/lib/python3.5',
 'LIBDIR': '/home/galaxy/galaxy/<tool_dependency_dir>/_conda/lib',
 'LIBFFI_INCLUDEDIR': '',
 'LIBM': '-lm',
 'LIBOBJDIR': 'Python/',
 'LIBOBJS': '',
 'LIBPC': '/home/galaxy/galaxy/<tool_dependency_dir>/_conda/lib/pkgconfig',
 'LIBPL': '/home/galaxy/galaxy/<tool_dependency_dir>/_conda/lib/python3.5/config-3.5m',
 ...
 'MACHDEPS': 'plat-linux',
 'MACHDEP_OBJS': '',
 'MACHDESTLIB': '/home/galaxy/galaxy/<tool_dependency_dir>/_conda/lib/python3.5',
 'MACOSX_DEPLOYMENT_TARGET': '',
 'MAINCC': 'gcc -pthread',
 'MAJOR_IN_MKDEV': 0,
 'MAJOR_IN_SYSMACROS': 0,
 'MAKESETUP': './Modules/makesetup',
 'MANDIR': '/home/galaxy/galaxy/<tool_dependency_dir>/_conda/share/man',
 'MKDIR_P': '/bin/mkdir -p',
 'MODLIBS': '',
 ...
 'PY_CORE_CFLAGS': '-Wsign-compare -DNDEBUG -g -fwrapv -O3 -Wall '
                   ...
                   '-I/home/galaxy/galaxy/<tool_dependency_dir>/_conda/include -fPIC '
                   '-DPy_BUILD_CORE',
 'PY_CPPFLAGS': '-I. -IInclude -I./Include '
                '-I/home/galaxy/galaxy/<tool_dependency_dir>/_conda/include',
 'PY_FORMAT_LONG_LONG': '"ll"',
 'PY_FORMAT_SIZE_T': '"z"',
 'PY_LDFLAGS': '-L/home/galaxy/galaxy/<tool_dependency_dir>/_conda/lib '
               '-Wl,-rpath=/home/galaxy/galaxy/<tool_dependency_dir>/_conda/lib,--no-as-needed',
 'Py_DEBUG': 0,
 'Py_ENABLE_SHARED': 1,
 'Py_HASH_ALGORITHM': 0,
 ...
 'SCRIPTDIR': '/home/galaxy/galaxy/<tool_dependency_dir>/_conda/lib',
 'SETPGRP_HAVE_ARG': 0,
 'SGI_ABI': '',
 'SHELL': '/bin/sh',
 ...
 'TCLTK_INCLUDES': '-I/home/galaxy/galaxy/<tool_dependency_dir>/_conda/include',
 'TCLTK_LIBS': '-L/home/galaxy/galaxy/<tool_dependency_dir>/_conda/lib -ltcl8.5 -ltk8.5',
 'TESTOPTS': '',
 'TESTPATH': '',
 ...
 'cross_compiling': 'no',
 'datarootdir': '/home/galaxy/galaxy/<tool_dependency_dir>/_conda/share',
 'exec_prefix': '/home/galaxy/galaxy/<tool_dependency_dir>/_conda',
 'prefix': '/home/galaxy/galaxy/<tool_dependency_dir>/_conda',
 'srcdir': '.'}
