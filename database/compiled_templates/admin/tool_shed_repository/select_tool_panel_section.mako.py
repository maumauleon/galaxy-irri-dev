...
_magic_number = 10
_modified_time = 1501214154.910417
_enable_loop = True
...
def render_body(context,**pageargs):
    ...
    try:
        ...
        _import_ns = {}
        _mako_get_namespace(context, '__anon_0x7f3534045ad0')._populate(_import_ns, [u'render_dependencies_section'])
        _mako_get_namespace(context, '__anon_0xa8d8cd0')._populate(_import_ns, [u'render_msg'])
        _mako_get_namespace(context, '__anon_0x7f3534045610')._populate(_import_ns, [u'*'])
        _mako_get_namespace(context, '__anon_0x7f3534045dd0')._populate(_import_ns, [u'render_readme_section'])
