...
_magic_number = 10
_modified_time = 1501221674.556455
_enable_loop = True
...
def _mako_generate_namespaces(context):
    ns = runtime.TemplateNamespace('__anon_0x7fa52c30bad0', context._clean_inheritance_tokens(), templateuri=u'/dataset/display.mako', callables=None,  calling_uri=_template_uri)
...
def render_body(context,**pageargs):
    ...
    try:
        ...
        _import_ns = {}
        _mako_get_namespace(context, '__anon_0x7fa52c30bad0')._populate(_import_ns, [u'render_deleted_data_message'])
