...
_magic_number = 10
_modified_time = 1500946389.524085
_enable_loop = True
...
def _mako_generate_namespaces(context):
    ns = runtime.TemplateNamespace('__anon_0x7f16683e6f10', context._clean_inheritance_tokens(), templateuri=u'/galaxy_client_app.mako', callables=None,  calling_uri=_template_uri)
    context.namespaces[(__name__, '__anon_0x7f16683e6f10')] = ns
...
def render_body(context,**pageargs):
    ...
    try:
        ...
        _import_ns = {}
        _mako_get_namespace(context, '__anon_0x7f16683e6f10')._populate(_import_ns, [u'get_user_dict'])
...
"""
__M_BEGIN_METADATA
{"source_encoding": "ascii", "line_map": {"33": 1, "34": 81, "97": 91, "40": 4, "87": 62, "51": 4, "52": 5, "85": 36, "86": 39, "23": 1, "88": 69, "89": 69, "26": 0, "91": 74, "90": 74}, "uri": "/webapps/galaxy/galaxy.masthead.mako", "filename": "templates/webapps/galaxy/galaxy.masthead.mako"}
__M_END_METADATA
"""
